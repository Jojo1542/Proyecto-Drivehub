...
class GetAllFleetRequest {
    
    private static let url = "\(NetworkConfiguration.baseUrl)/fleet/all";
 
    static func getAllFleets(sessionToken: String, completion: @escaping (Callback<[FleetModel], Int>) -> Void) {
