//
//  GetAssignedShipmentRequest.swift
//  Frontend
//
...
class GetAssignedShipmentRequest {
    
    private static let url = "\(NetworkConfiguration.baseUrl)/ship/listOwn";
    
    static func getAssignedShipments(sessionToken: String, completion: @escaping (Callback<[ShipmentModel], Int>) -> Void) {
