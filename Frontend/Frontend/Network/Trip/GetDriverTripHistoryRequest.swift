//
//  GetDriverTripHistoryRequest.swift
//  Frontend
//
...
class GetDriverTripHistoryRequest {
    
    private static let url = "\(NetworkConfiguration.baseUrl)/trip/history/driver";
 
    static func getTripHistory(sessionToken: String, completion: @escaping (Callback<[TripModel], Int>) -> Void) {
